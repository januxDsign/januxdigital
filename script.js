...
function initTheme() {
    ...
    // Check if on mobile AND check system preference
    ...
    if (savedTheme) {
        ...
        // Only sync with system by default if on mobile
        setTheme(systemPrefersDark ? 'dark' : 'light');
    } else {
        // Desktop defaults to dark
        setTheme('dark');
    }
    ...
    function setTheme(theme) {
        ...
        // (The line rewriting the innerHTML emoji has been completely removed)
    }
}
...
const servicesData = {
    ...
    'pack': { 
        ...
        benefits: [
            'Custom dielines and structural layout design', 
            'Print-ready CMYK files with exact bleed margins', 
            'Photorealistic 3D mockups for presentation', 
            'Brand-aligned visual aesthetics and typography'
        ]
    },
    'cv': { 
        ...
        benefits: [
            'Clean, ATS-friendly modern layouts', 
            'Strategic visual hierarchy to highlight key skills', 
            'Delivered in fully editable Word and PDF formats', 
            'Customized to your specific industry standards'
        ] 
    },
    'word': { 
        ...
        benefits: [
            'Fully editable and reusable Microsoft Word templates', 
            'Custom branded headers, footers, and cover pages', 
            'Automated table of contents and defined text styles', 
            'Locked structural elements to protect brand integrity'
        ]
    },
    'ppt': { 
        ...
        benefits: [
            'Engaging, custom-designed slide layouts', 
            'Bespoke infographics and data visualization', 
            'Configured Master Slides for easy future editing', 
            'Seamless, professional animations and transitions'
        ]
    }
};

const footerDocsData = {
    'faq': `<h2 style="font-size: 2.5rem; margin-bottom: 30px; color: var(--text-main);">Frequently Asked <span style="color: var(--accent-green);">Questions.</span></h2>
    ...
    'terms': `<h2 style="font-size: 2.5rem; margin-bottom: 30px; color: var(--text-main);">Terms & <span style="color: var(--accent-green);">Conditions.</span></h2>
              <div style="color: var(--text-muted); line-height: 1.8; text-align: left;">
...
function openServiceXpop(serviceId) {
    ...
    // Dynamically generate the <li> elements based on the specific service clicked
